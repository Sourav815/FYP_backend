...
export interface ApiVerificationVerification
  ...
  attributes: {
    Affiliation: Schema.Attribute.String & Schema.Attribute.Required;
    Certificate_Id: Schema.Attribute.String & Schema.Attribute.Required;
    Conference_Name: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Purpose: Schema.Attribute.String & Schema.Attribute.Required;
